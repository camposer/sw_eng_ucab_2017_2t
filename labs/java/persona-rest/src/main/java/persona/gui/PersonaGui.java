...
public class PersonaGui {
    ...
    // TODO Incluir capa de l�gica de negocio
    private PersonaDao personaDao;

    public PersonaGui() {
        scanner = new Scanner(System.in);
        try {
            Connection con = DataSourceFactory.createMySqlDataSource().getConnection();
    ...
    private void insertar() {
        ...
        try {
            ...
            System.out.println("Edad inv�lida, utilizando 0");
            System.err.println(e); // TODO Cambiar por un logger
        }

        // TODO Cambiar construcci�n de persona por un builder
        try {
